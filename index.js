...
function getWinnersByYear(array, years, country, getWinnerscb, getYearscb){
    const winnersByYear = getWinners(array).map (item => item.Year)
    }
...
function getAverageGoals(array, getFinals) {
